    ...
    <section class="pt pb">
      <b-container>
        <section class="pt pb">
          ...
          <InnerTitle
            :title="
              t('A cookie does not hold any of your personal information')
            "
            sub
          />
