<template>
  <StaticLayout :title="$t('aml_title')" :subtitle="$t('aml_subtitle')">
    <section class="pt pb">
      <b-container>
        ...
        <article>
          ...
          <ContainerInner>
            <InnerTitle title="purpose" sub />
            <p class="terms-content">{{ $t('purpose_p1') }}</p>
            <p class="terms-content">{{ $t('purpose_p2') }}</p>
          </ContainerInner>

          <ContainerInner>
            <InnerTitle title="definitions" sub />
            <p class="terms-content">{{ $t('definitions_p1') }}</p>
            <p class="terms-content m-0">{{ $t('definitions_p2') }}</p>
            <Listing
              translation="aml"
              :list="[
                'definitions_l1',
            ...
            <p class="terms-content">{{ $t('definitions_p3') }}</p>
            <p class="terms-content">{{ $t('definitions_p4') }}</p>
            <p class="terms-content m-0">{{ $t('definitions_p5') }}</p>
            <Listing
              translation="aml"
              :list="[
                'definitions_l5',
            ...
            />
            <p class="terms-content">{{ $t('definitions_p6') }}</p>
            <Listing
              translation="aml"
              :list="[
                'definitions_l9',
            ...
            />
            <p class="terms-content">{{ $t('definitions_p7') }}</p>
            <p class="terms-content">{{ $t('definitions_p8') }}</p>
            <p class="terms-content">{{ $t('definitions_p9') }}</p>
          ...
          <ContainerInner>
            ...
            <section class="sub-list">
              <p class="terms-content">{{ $t('anti_money_p3') }}</p>
              <p class="terms-content">{{ $t('anti_money_p4') }}</p>

              <Listing translation="aml" :list="['anti_money_l2']" />
              <p class="terms-content">{{ $t('anti_money_p5') }}</p>
              <Listing
                translation="aml"
                :list="['anti_money_l3', 'anti_money_l4', 'anti_money_l5']"
              />
              <p class="terms-content">{{ $t('anti_money_p6') }}</p>
              <p class="terms-content m-0">{{ $t('anti_money_p7') }}</p>
              <p class="terms-content">{{ $t('anti_money_p8') }}</p>
              <p class="terms-content m-0">{{ $t('anti_money_p8') }}</p>
              <p class="terms-content">{{ $t('anti_money_p9') }}</p>
              <p class="terms-content m-0">{{ $t('anti_money_p10') }}</p>
              <p class="terms-content">{{ $t('anti_money_p11') }}</p>
              <p class="terms-content">{{ $t('anti_money_p12') }}</p>
            </section>
            <Listing translation="aml" :list="['compliance_l1']" />
            <section class="sub-list">
              <p class="terms-content">{{ $t('compliance_p1') }}</p>
              <p class="terms-content">{{ $t('compliance_p2') }}</p>
              ...
              />
              <p class="terms-content">{{ $t('compliance_p3') }}</p>
              <Listing translation="aml" :list="['senior_l1']" />
              <p class="terms-content">{{ $t('senior_p1') }}</p>
              <Listing
                translation="aml"
                :list="[
                  'senior_l2',
          ...
          <ContainerInner>
            <InnerTitle title="Customere Diligence" sub />
            <p class="terms-content">
              {{
                $t(
            ...
            <Listing
              ...
              :list="[
                ...
                'the risk level of the Customer or of the transaction does not comply with companys risk appetite',
              ]"
            />
            ...
            <Listing
              translation="aml"
              :list="[
                'the Customers risk profile indicates high or very high-risk level of ML /TF',
            ...
            <p class="terms-content">
              ...
              Sanctions Map indicates the types of sanctions, the legislation or
              the resolution that adopted the specific restrictive measures,
              provides an extensive search mechanism, as well as detailed
              explanations, such as which goods are prohibited from entering the
              country or territory, etc. The results of the research shall be
              documented in the research section of the client, indicating the
              results of the research and the date of the research
            </p>
            ...
            <Listing translation="aml" :list="['Monitoring of transactions']" />
            ...
            <Listing
              ...
              :list="[
                ...
                'may affect the Customers risk profile score.',
              ]"
            />
            <p class="terms-content">
              {{
            ...
            <Listing
              ...
              :list="[
                ...
                'the entity for whose benefit the Monetary Operation was executed (if its possible); ',
