<template>
  <StaticLayout :title="$t('privacy_title')" :subtitle="$t('privacy_subtitle')">
    <section class="pt pb">
      <b-container>
        <InnerTitle :title="$t('privacy_title')" />
        <article>
          ...
          <p class="terms-content">
            <template v-if="language === 'en'">
              The Company is committed to protecting all users' privacy. Before
              using or accessing websites operated by us including, API located
              on{" "}
              <a href="https://trade.otix.exchange/api/documentation">
                https://trade.otix.exchange/api/documentation </a
          ...
          <ContainerInner>
            ...
            <p class="terms-content">
              {{
                $t('your_personal_information_will_be_collected_used_disclosed')
              }}
              :
            </p>
            <Listing
          ...
          <ContainerInner>
            ...
            <p class="terms-content">{{ $t('physical_safeguards') }}</p>
          </ContainerInner>
          ...
          <ContainerInner>
            ...
            <p class="terms-content">{{ $t('legal_obligation') }}</p>
            <p class="terms-content">
              {{
                $t(
          ...
          <ContainerInner>
            ...
            <p class="terms-content">{{ $t('for_business_reasons') }}</p>
            <p class="terms-content">
              {{
                $t(
          ...
          <ContainerInner>
            <InnerTitle
              :title="
                $t('transfers_of_personal_information_outside_of_your_country')
              "
              sub
            />
            <p class="terms-content">
          ...
          <ContainerInner>
            ...
            <p class="terms-content">{{ $t('in_some_instances') }}</p>
          ...
          <ContainerInner>
            ...
            <p class="terms-content">
              <template v-if="language === 'en'">
                If you have a privacy issue, a complaint, or a question for the
                Data Protection Officer, please use the Contact form to get in
                touch via email:{" "}
                <a href="compliance@otix.exchange"> compliance@otix.exchange </a
                >{" "} We will react within 30 days to any inquiries or
                complaints
              </template>
            </p>
          </ContainerInner>
